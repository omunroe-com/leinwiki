...
* "lein-retest":http://github.com/technomancy/lein-retest Run only the test namespaces which failed last time around.
...
* "midje":http://github.com/marick/Midje/tree/master/leiningen/ Run "Midje":http://github.com/marick/Midje/blob/master/README.md tests.
...
* "lein-reload":https://github.com/paraseba/lein-reload Reload modified files automatically every time you run tests
