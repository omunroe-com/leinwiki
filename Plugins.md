...
## Development Tools
-   [lein-v](https://github.com/roomkey/lein-v) A leiningen plugin for integrating project versions more tightly with git.  Never edit `project.clj` again to update a version.  See the [blog post](https://techblog.roomkey.com/posts/2016-07-21-versions.html). 
...
-   [lein-codeindex](https://github.com/sanel/lein-codeindex) Index code and all project dependencies using etags, ctags or gtags
...
-   [io.aviso/pretty](https://github.com/AvisoNovate/pretty) Enable formatted, colorized, readable exceptions
...
-   [lein-less4j](https://github.com/Deraen/less4clj) Compile [Less CSS](http://lesscss.org/) using [Less4j](https://github.com/SomMeri/less4j). Supports reading imports from classpath.
-   [lein-ragel](https://github.com/llasram/lein-ragel) Compile Ragel sources to Java sources
-   [lein-sass4clj](https://github.com/Deraen/sass4clj) Compile [Sass](http://sass-lang.com/) using Libsass over JNA.
...
-   [lein-test-partition](https://github.com/icmconsulting/lein-test-partition) Partition your tests automatically, to run across multiple build nodes
...
-   [lein-lambda](https://github.com/paulbutcher/lein-lambda) An opinionated Leiningen plugin to automate AWS Lambda deployments, and a template to create projects that use it.
...
-   [lein-release-4digit-version](https://github.com/puppetlabs/lein-release-4digit-version) Leiningen plugin that enhances `lein release` and `lein change` with 4 digit version numbering schemes.
